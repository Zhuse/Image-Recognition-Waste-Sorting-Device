...
import garbageIcon from '../images/compost.png';

export default class CompostScreen extends Component {
    constructor() {
        super();
        this.state = {
            timesOpened: 0,
    ...
    renderItem = ({item}) => {
        if(item.bin == 3){ //TODO CHANGE THIS
            return (
